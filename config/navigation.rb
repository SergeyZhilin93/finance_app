...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    # name - will be displayed in the rendered navigation. This can also be a call to yoI18n-ur framework.
    ...
    #
    primary.item :payments, I18n.t('.payment'), payments_transactions_path
    primary.item :incomes, I18n.t('.income'), incomes_transactions_path
    primary.item :charts, I18n.t('.chart'), nil
    primary.item :settings, I18n.t('.setting'), categories_path
